...
export function buildWorkspaceSystemPrompt(context: WorkspaceContext): string {
  ...
  const prompt = [
    ...
    "Pembuatan atau penghapusan tim/divisi adalah administrasi workspace milik pemilik dan tidak boleh dilakukan oleh AI team mana pun dari chat. Jika diminta, tolak dengan jelas dan arahkan pemilik ke pengaturan workspace. Jangan mengklaim tindakan tersimpan jika tool tidak berhasil.",
